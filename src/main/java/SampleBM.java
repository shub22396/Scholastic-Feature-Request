...
public class SampleBM {
    ...
    public void setup(String browser, String version, String platform) throws Exception {
        ...
        System.out.println("SESSION : " + driver.get().getSessionId() + " --- " + version);
    }
    ...
    public void test() throws Exception {
        ...
        driver.get().findElement(By.name("q")).sendKeys("LambdaTest");
        driver.get().findElement(By.name("q")).sendKeys(Keys.ENTER);
        Thread.sleep(5000);

        driver.get().get("https://lambdatest.com");
...
//            if(driver!=null) {
                ...
                try {
                    System.out.println("Quit ------- :"+driver.get().getSessionId());
                    driver.get().quit();              //quitting the driver instance
...
//            }
    ...
    @AfterSuite
    public void after_suit() throws Exception {
